        ...
        (function (decompiler) {
            ...
            function decompileToBlocks(blocksInfo, file, options, renameMap) {
                ...
                function getPropertyAccessExpression(n, asField, blockId) {
                    ...
                    var idfn = blockId ? blocksInfo.blocksById[blockId] : blocksInfo.apis.byQName[attributes.blockIdentity];
                ...
                function getForStatement(n) {
                    ...
                    if (condition.operatorToken.kind === SK.LessThanToken && !checkForVariableUsages(n.statement)) {
                        ...
                        r.inputs = [];
                        r.handlers = [];
                        r.inputs = [mkValue("VAR", getFieldBlock("variables_get_reporter", "VAR", renamed, true), "variables_get_reporter")];
